...
const faqs = [
  ...
  {
    question: "I've never created a digital product before. Will this work for me?",
    ...
    <section className="py-24 px-4 bg-gradient-to-b from-ground to-white ">
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="mt-4 text-lg text-gray-600">Everything you need to know about our membership</p>
        </motion.div>
