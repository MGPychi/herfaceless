        ...
        <CardContent className="space-y-8">
          ...
          >
            <p className="text-2xl leading-relaxed">
              With our <span className="font-semibold">SIS Inner Circle Membership</span>, 
              you&apos;ll learn how to <span className="font-bold">create digital products that sell</span>, 
              and never feel <span className="italic">stuck or overwhelmed</span> again!
            </p>
          </motion.div>
          ...
          <div className="space-y-8">
            <motion.div
              ...
              className="space-y-6"
            >
              <h2 className="text-2xl font-semibold">Say goodbye to...</h2>
              {[
            ...
            <motion.div
              ...
              className="space-y-6"
            >
              <h2 className="text-2xl font-semibold">Instead you&apos;ll...</h2>
              {[
