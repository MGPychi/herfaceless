...
const testimonials = [
	{
		id: 1,
		content:
			"I earned an extra $10K in my first 2 months through launching digital products!",
		author: "John D.",
	...
	},
	{
		id: 2,
		content:
			"My content strategy led to 500K+ views and 6-figure sales in just one week!",
		author: "Michael S.",
		avatar: "/placeholder.svg?height=40&width=40",
	...
	},
	{
		id: 3,
		content:
			"Scaled from $0 to $25K monthly recurring revenue in just 90 days using this framework.",
		author: "David L.",
		avatar: "/placeholder.svg?height=40&width=40",
	...
	},
	{
		id: 4,
		content:
			"Launched my first digital product and made $15K in pre-sales alone!",
		author: "Tom R.",
		avatar: "/placeholder.svg?height=40&width=40",
