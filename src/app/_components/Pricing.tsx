          ...
          >
            <Card className="h-full flex flex-col">
              ...
              <CardContent className="flex-grow">
                ...
                >
                  {plan.pricingItems.map((planFeature) => (
                    <motion.li key={planFeature.id} variants={item} className="flex items-start gap-2">
              ...
              <CardFooter className="mt-auto">
                <Button asChild aria-label="sign me up button" className="w-full bg-[#dbc1b0] hover:bg-[#b17f65] text-black py-6 text-lg">
