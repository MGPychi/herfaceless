...
const benefits = [
  ...
  },
  {
    ...
    description: "Step-by-step blueprints for business growth, tailored to your industry and goals."
  },
  {
    icon: <DollarSign className="w-6 h-6" />,
    title: "Revenue Acceleration Tactics",
    description: "Proven strategies to boost your income and scale your business efficiently."
  },
  {
    icon: <LineChart className="w-6 h-6" />,
    title: "Business & Personal Growth",
    description: "Develop leadership skills and business acumen to become a top performer in your field."
  },
  {
      ...
      <div className="container mx-auto">
        ...
        >
          ...
          <p className="text-xl text-center text-gray-600 mb-16 max-w-3xl mx-auto">
            Unlock a suite of powerful tools and resources designed to skyrocket your business growth and personal development.
          </p>
...
function IllustrationBusiness() {
  return (
    <svg viewBox="0 0 200 200" className="w-full h-full">
      <rect x="60" y="80" width="80" height="100" rx="10" className="fill-[#003366]" />
      <circle cx="100" cy="100" r="25" className="fill-[#0066cc]" />
      <rect x="75" y="90" width="50" height="60" rx="25" className="fill-[#0066cc]" />
      <rect x="85" y="110" width="40" height="30" rx="5" className="fill-[#e6f2ff]" />
      <rect x="85" y="130" width="40" height="5" rx="2" className="fill-[#003366]" />
...
function IllustrationPlant() {
  return (
    <svg viewBox="0 0 50 50" className="w-full h-full">
      <rect x="20" y="35" width="10" height="15" className="fill-[#0066cc]" />
