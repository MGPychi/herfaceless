					...
					<CardContent className="space-y-6">
						<div className="prose prose-stone mx-auto">
							<p className="text-lg leading-relaxed text-center max-w-2xl mx-auto">
								At HersFaceless.com, we are confident in the
								value of our digital products and services. For
								this reason, we do not offer refunds for
								one-time purchases. We encourage you to review
								the product details carefully before making a
								purchase, as all sales are final.
							</p>
